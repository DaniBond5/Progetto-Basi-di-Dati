<?php
    ...
    $risultato=pg_prepare($db,"vis_carriera_studente_storico",$sql);
    $risultato=pg_execute($db,"vis_carriera_studente_storico",$parametri);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5 border">
        <h3 class="text-center">Carriera Completa Studente Storico</h3>
        </br>
        <?php 
        // In caso di mancanza di risultati
        if (count($carriera_studente) == 0) {?>
            <div class="alert alert-warning" role="alert">
                <p>Nessun Esame in Carriera per lo studente storico</p>
            </div>
        <?php }
