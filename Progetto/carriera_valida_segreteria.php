<?php
    ...
    SELECT carriera.matricola,carriera.id_corso,carriera.id_insegnamento,carriera.id_docente,carriera.data_esame,carriera.voto
...
<html lang="en">
  <head>
    <title>Carriera Valida Studente</title>
    <meta charset="utf-8">
    ...
    <div class="container mt-5 border">
        ...
        if (count($carriera_studente) == 0) {?>
            <div class="alert alert-warning" role="alert">
                <p>Nessun Esame o nessun esame sufficiente in Carriera per lo studente</p>
            </div>
        <?php }
